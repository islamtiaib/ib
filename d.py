...
def id_teman():
    ...
    try:
        ...
        print 50 * '\x1b[1;91m\xe2\x94\x80'
        bz = open('/sdcard/id_teman_from_teman.txt', 'w')
        ...
        os.rename('/sdcard/id_teman_from_teman.txt', '/sdcard/' + done)
...
def idfrom_follow():
    ...
    try:
        ...
        jalan('\x1b[1;95m • \x1b[1;91mLoading IDs Now \x1b[1;97m...')
        print 50 * '\x1b[1;91m\xe2\x94\x80'
        bz = open('/sdcard/idfrom_follow.txt', 'w')
        for a in z['friends']['data']:
        ...
        os.rename('/sdcard/idfrom_follow.txt', '/sdcard/' + done)
        print '\r\x1b[1;93m [\x1b[1;92m\xe2\x80\xa2\x1b[1;93m] \x1b[1;92mSaved files \x1b[1;91m: \x1b[1;92mout/' + done
        raw_input('\n\x1b[1;93m [\x1b[1;91mReturn\x1b[1;93m]')
        dump()
    except OSError:
...
def idfrom_react():
    ...
    try:
        ...
        jalan('\x1b[1;95m • \x1b[1;91mLoading IDs Now \x1b[1;97m...')
        print 50 * '\x1b[1;91m\xe2\x94\x80'
        bz = open('/sdcard/idfrom_react.txt', 'w')
        for a in z['friends']['data']:
        ...
        os.rename('/sdcard/idfrom_react.txt', '/sdcard/' + done)
        print '\r\x1b[1;93m [\x1b[1;92m\xe2\x80\xa2\x1b[1;93m] \x1b[1;92mSaved files \x1b[1;91m: \x1b[1;92mout/' + done
        raw_input('\n\x1b[1;93m [\x1b[1;91mReturn\x1b[1;93m]')
        dump()
    except OSError:
